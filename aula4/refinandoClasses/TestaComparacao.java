...
public class TestaComparacao {
	...
	public static void main(String[] args) {
		...
		System.out.println("\ncomparacao de '"+nomes1[0]+"' com '"+nomes1[2]+"':"+
		...
		pessoas.add(new Pessoa("Ziraldo",90));
		pessoas.add(new Pessoa("Arlindo",75));
		pessoas.add(new Pessoa("Aarão",80));
		pessoas.add(new Pessoa("Ziraldo",80));
